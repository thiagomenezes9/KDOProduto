                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form class="form-horizontal" action="{{route('produtos.store')}}" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                <label for="cdbarras" class="col-sm-2 control-label" >Código de Barras</label>
                                <div class="col-sm-10">
                                    <textarea name="cdbarras" value="{{ old('cdbarras') }}" type="text" class="form-control input-lg"
                                              id="cdbarras" placeholder="Código de Barras" autofocus></textarea>
                                </div>
                            </div>
